...
ActiveRecord::Schema.define(version: 2022_04_21_033622) do
  ...
  create_table "booking_transactions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["room_id"], name: "index_booking_transactions_on_room_id"
    t.index ["user_id"], name: "index_booking_transactions_on_user_id"
  end

  create_table "galleries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "hotel_id"
    t.integer "room_id"
  ...
  add_foreign_key "booking_transactions", "rooms"
